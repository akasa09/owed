...
$idkas = $_GET['id'];
include 'koneksi.php';
$ambildata = "SELECT * FROM tb_kaskeluar WHERE idkaskeluar='$idkas'";
        ...
        <div class="card">
            <div class="card-body">
                <div class="col-sm-15">
                    ...
                    <br><br>
                    <form role="form" method="POST" action="logic/update-kaskeluar.php">
                        <div class="form-group" method="post">
                            ...
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    ...
                                    <input type="text" class="form-control" name="idkas" placeholder="masukan id kas masuk" value="<?= $aray['idkaskeluar'] ?>" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="form-group" method="post">
